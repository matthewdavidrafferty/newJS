...
document.getElementById("clickbutton").addEventListener("click", clickfunction)

function clickfunction() {
    document.getElementById("grandtotal").innerHTML = "Your Order Total is $ " + totalOrderAmt
}